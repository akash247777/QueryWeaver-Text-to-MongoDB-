...
export type StreamMessageType =
  ...
  | 'mongodb_query'   // Backend sends this for MongoDB queries
  | 'result'
...
export interface ConfirmRequest {
  mongodb_query: string;      // The MongoDB query to execute

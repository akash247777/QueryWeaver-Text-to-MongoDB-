      ...
      <DialogContent className="sm:max-w-[600px] bg-gray-900 text-white border-gray-700">
        <DialogHeader>
          ...
          <DialogDescription className="text-gray-400">
            Define custom rules and specifications for query generation. These rules will be applied to all your queries.
          </DialogDescription>
        </DialogHeader>
...
- Use $project to limit returned fields`}
          ...
          <div className="bg-blue-900/20 border border-blue-800/30 rounded-lg p-3">
            <p className="text-xs text-blue-300">
              <strong>💡 Tip:</strong> These rules help the AI understand your preferences and constraints when generating MongoDB queries.

            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-xs md:text-sm text-muted-foreground mt-1">
                  Define custom rules and specifications for query generation. Changes are saved automatically.
                </p>
              </div>
            </div>
          </div>
...
- Limit results to 100 documents unless specified
- Always sort results for consistency
- Use $lookup for joining related collections
- Use $project to limit returned fields
- Prefer explicit field names over returning all fields
- Use descriptive field aliases for clarity`}
                  value={rules}

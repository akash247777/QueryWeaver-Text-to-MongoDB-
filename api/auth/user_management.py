"""User management and authentication functions for text-to-MongoDB query API."""
    ...
    async def wrapper(request: Request, *args, **kwargs):
        try:
            ...
            if not is_authenticated:
                # Local development bypass: Use a guest user if no auth is configured
                # This allows using the app without Google/GitHub OAuth setup
                user_info = {
                ...
                logging.info("Using local Guest authentication fallback")

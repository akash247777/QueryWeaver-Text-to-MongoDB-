...
class FollowUpAgent(BaseAgent):  # pylint: disable=too-few-public-methods
    ...
    def generate_follow_up_question(
        ...
        """
        Generate helpful follow-up questions based on failed query translation.
        
        Args:
            user_question: The original user question
            analysis_result: Output from analysis agent 
            schema_info: Database schema information
            found_tables: Collections found by the find function
        ...
        is_translatable = (
            analysis_result.get("is_query_translatable", False)

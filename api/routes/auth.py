"""Authentication routes for the text-to-MongoDB query API."""
# pylint: disable=all
...
async def auth_status(request: Request) -> JSONResponse:
    ...
    # Local development bypass: Automatically authenticate as Guest if no social login set up
    # This ensures developers don't get stuck at the login modal during local setup
    return JSONResponse(
        content={
            "authenticated": True, 
            "user": {

"""Database connection routes for the text-to-MongoDB query API."""
...
def _step_detect_db_type(steps_counter: int, url: str) -> tuple[type[BaseLoader], dict[str, str]]:
    ...
    if url.startswith("mongodb://") or url.startswith("mongodb+srv://"):
        ...
        raise InvalidArgumentError("Invalid database URL format. Only MongoDB is supported.")
